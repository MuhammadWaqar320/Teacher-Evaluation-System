...
const Sub_allStudent = () => {
     ...
     const tableHeader=["Id","Name","Cnic","Father Name","Phone No.","Email","Department","Semester"]
    ...
    <TableComponent data={allStudentData} type={USER_TYPE.Student} header={tableHeader} />
