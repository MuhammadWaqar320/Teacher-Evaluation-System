...
import AllocatedCourse from "./allocatedCourse/allocatedCourse";
import EditTeacherProfile from "./editTeacherProfile/editTeacherProfile";
import RatingDetail from "./ratingDetail/ratingDetail";
import ViewTeacherProfile from "./viewTeacherProfile/viewTeacherProfile";
        ...
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div">
            <Link to="/" style={{ textDecoration: "none", color: "white" }}>
              ...
              <span className="title-class">TES Teacher Dashboard</span>
            </Link>
          </Typography>
